...
export class MochaOptionsLoader {
    ...
    loadMocha6Options(overrides) {
        ...
        const rawConfig = (_a = LibWrapper.loadOptions(args)) !== null && _a !== void 0 ? _a : {};
        ...
        options.forEach((option) => {
            ...
            if (args[0]) {
                switch (args[0]) {
                    ...
                    case '--ui':
                    case '-u':
                        mochaRunnerOptions.ui = (_a = this.parseNextString(args)) !== null && _a !== void 0 ? _a : DEFAULT_MOCHA_OPTIONS.ui;
                        break;
                    case '--grep':
                    case '-g':
...
MochaOptionsLoader.inject = tokens(commonTokens.logger);
